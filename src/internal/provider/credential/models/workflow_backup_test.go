...
func TestWorkflowBackup(t *testing.T) {
	...
	t.Run("workflow with complex structure", func(t *testing.T) {
	...
	t.Run("modify backup", func(t *testing.T) {
	...
	t.Run("array of backups", func(t *testing.T) {
	...
	t.Run("map of backups", func(t *testing.T) {
	...
	t.Run("backup use case simulation", func(t *testing.T) {
	...
	t.Run("empty workflow backup", func(t *testing.T) {
...
func TestWorkflowBackupEdgeCases(t *testing.T) {
	t.Run("backup with nil workflow operations", func(t *testing.T) {
	...
	t.Run("backup restoration scenario", func(t *testing.T) {
	...
	t.Run("multiple backups of same workflow", func(t *testing.T) {
	...
	t.Run("backup chain", func(t *testing.T) {
	...
	t.Run("partial workflow backup", func(t *testing.T) {
