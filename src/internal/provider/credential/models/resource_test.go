...
func TestResource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "create with empty data map", wantErr: false},
		{name: "partial initialization", wantErr: false},
		{name: "zero value struct", wantErr: false},
		{name: "modify values", wantErr: false},
		{name: "various credential types", wantErr: false},
		{name: "complex data map", wantErr: false},
		...
		{name: "data map with different value types", wantErr: false},
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			case "create with empty data map":
			...
			case "data map with different value types":
