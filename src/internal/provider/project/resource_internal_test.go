...
func TestProjectResource_updatePlanFromProject(t *testing.T) {
	...
	t.Run("updates plan with all fields", func(t *testing.T) {
	...
	t.Run("handles nil type", func(t *testing.T) {
		projWithNilType := &n8nsdk.Project{
			Id:   &id,
			Name: "Test Project",
			Type: nil,
		}
		...
		r.updatePlanFromProject(plan, projWithNilType)
...
func TestProjectResource_updateStateFromProject(t *testing.T) {
	...
	t.Run("updates state with all fields", func(t *testing.T) {
		...
		assert.Equal(t, "organization", state.Type.ValueString())
	})
	...
	t.Run("handles nil type", func(t *testing.T) {
		...
		r.updateStateFromProject(state, projWithNilType)
...
func TestProjectResource_updateModelFromProject(t *testing.T) {
	...
	t.Run("updates model with all fields", func(t *testing.T) {
		model := &models.Resource{}
		r := &ProjectResource{}

		r.updateModelFromProject(project, model)

		assert.Equal(t, "Final Project", model.Name.ValueString())
	...
	t.Run("handles nil type", func(t *testing.T) {
		...
		r.updateModelFromProject(projWithNilType, model)
