...
// Package models contains data models for workflow connection resources.
package models
...
// Resource describes the workflow connection resource data model.
...
type Resource struct {
	...
	// SourceOutputIndex is the index of the source output (for nodes with multiple outputs like Switch).
