...
type ExecutionAPI interface {
	...
	*/
	...
	/*
		ExecutionsIdTagsGet Get execution tags
	...
	*/
	...
	/*
		ExecutionsIdTagsPut Update tags of an execution
...
func (a *ExecutionAPIService) ExecutionsIdTagsGetExecute(r ExecutionAPIExecutionsIdTagsGetRequest) ([]Tag, *http.Response, error) {
	...
	localVarPath := localBasePath + "/executions/{id}/tags"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ExecutionAPIExecutionsIdTagsPutRequest) TagIdsInner(tagIdsInner []TagIdsInner) ExecutionAPIExecutionsIdTagsPutRequest {
