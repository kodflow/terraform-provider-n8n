...
type ProjectsAPI interface {
	...
	*/
	...
	/*
		...
		Returns a list of all members of a project including their role.
...
// ProjectsAPIProjectsProjectIdUsersGetRequest is the request for listing project members.
...
// ProjectsProjectIdUsersGet returns a request builder for listing project members.
...
// ProjectsProjectIdUsersGetExecute executes the list project members request.
func (a *ProjectsAPIService) ProjectsProjectIdUsersGetExecute(r ProjectsAPIProjectsProjectIdUsersGetRequest) (*ProjectMemberList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/projects/" + strings.NewReplacer().Replace(r.projectId) + "/users"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
