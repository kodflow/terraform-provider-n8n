# Test workflow for Freshworks CRM
...
# WORKFLOW
resource "n8n_workflow" "test_freshworks-crm" {
  name       = "Test: Freshworks CRM"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_freshworks-crm.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_freshworks-crm.name
