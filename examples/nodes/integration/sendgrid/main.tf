...
# WORKFLOW
resource "n8n_workflow" "test_sendgrid" {
  name   = "Test: SendGrid"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_sendgrid.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_sendgrid.name
