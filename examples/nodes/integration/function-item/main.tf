# Test workflow for Function Item
...
# WORKFLOW
resource "n8n_workflow" "test_function-item" {
  name   = "Test: Function Item"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_function-item.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_function-item.name
