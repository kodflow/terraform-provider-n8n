...
# WORKFLOW
resource "n8n_workflow" "test_wait-amount" {
  name   = "Test: Wait Amount"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_wait-amount.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_wait-amount.name
