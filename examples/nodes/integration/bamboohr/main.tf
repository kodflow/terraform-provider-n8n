...
# WORKFLOW
resource "n8n_workflow" "test_bamboohr" {
  name   = "Test: BambooHr"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_bamboohr.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_bamboohr.name
