...
# WORKFLOW
resource "n8n_workflow" "test_freshdesk" {
  name   = "Test: Freshdesk"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_freshdesk.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_freshdesk.name
