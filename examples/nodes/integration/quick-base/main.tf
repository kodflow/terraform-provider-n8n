...
# WORKFLOW
resource "n8n_workflow" "test_quick-base" {
  name   = "Test: Quick Base"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_quick-base.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_quick-base.name
