...
# WORKFLOW
resource "n8n_workflow" "test_messagebird" {
  name   = "Test: MessageBird"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_messagebird.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_messagebird.name
