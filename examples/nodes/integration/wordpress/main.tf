...
# WORKFLOW
resource "n8n_workflow" "test_wordpress" {
  name       = "Test: Wordpress"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_wordpress.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_wordpress.name
