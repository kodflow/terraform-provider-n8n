...
# WORKFLOW
resource "n8n_workflow" "test_interval" {
  name       = "Test: Interval"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_interval.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_interval.name
