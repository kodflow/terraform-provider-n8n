...
# WORKFLOW
resource "n8n_workflow" "test_gotowebinar" {
  name   = "Test: GoToWebinar"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_gotowebinar.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_gotowebinar.name
