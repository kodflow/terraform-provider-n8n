...
# WORKFLOW
resource "n8n_workflow" "test_raindrop" {
  name       = "Test: Raindrop"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_raindrop.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_raindrop.name
