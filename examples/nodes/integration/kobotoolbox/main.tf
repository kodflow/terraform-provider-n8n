...
# WORKFLOW
resource "n8n_workflow" "test_kobotoolbox" {
  name       = "Test: KoBoToolbox"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_kobotoolbox.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_kobotoolbox.name
