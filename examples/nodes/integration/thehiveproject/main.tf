# Test workflow for TheHiveProject
...
# WORKFLOW
resource "n8n_workflow" "test_thehiveproject" {
  name   = "Test: TheHiveProject"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_thehiveproject.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_thehiveproject.name
