...
# WORKFLOW
resource "n8n_workflow" "test_agile-crm" {
  name       = "Test: Agile CRM"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_agile-crm.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_agile-crm.name
