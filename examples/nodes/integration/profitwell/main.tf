...
# WORKFLOW
resource "n8n_workflow" "test_profitwell" {
  name       = "Test: ProfitWell"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_profitwell.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_profitwell.name
