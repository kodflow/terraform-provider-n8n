...
# WORKFLOW
resource "n8n_workflow" "test_convertkit" {
  name   = "Test: ConvertKit"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_convertkit.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_convertkit.name
