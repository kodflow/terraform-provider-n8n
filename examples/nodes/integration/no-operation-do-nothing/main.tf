# Test workflow for No Operation, do nothing
...
# TESTED NODE: No Operation, do nothing
...
# WORKFLOW
resource "n8n_workflow" "test_no-operation-do-nothing" {
  name       = "Test: No Operation, do nothing"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_no-operation-do-nothing.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_no-operation-do-nothing.name
