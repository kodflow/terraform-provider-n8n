# Test workflow for APITemplate.io
...
# WORKFLOW
resource "n8n_workflow" "test_apitemplate-io" {
  name       = "Test: APITemplate.io"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_apitemplate-io.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_apitemplate-io.name
