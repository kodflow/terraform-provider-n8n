...
# WORKFLOW
resource "n8n_workflow" "test_tapfiliate" {
  name   = "Test: Tapfiliate"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_tapfiliate.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_tapfiliate.name
