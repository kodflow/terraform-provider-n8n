...
# WORKFLOW
resource "n8n_workflow" "test_date-time" {
  name   = "Test: Date & Time"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_date-time.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_date-time.name
