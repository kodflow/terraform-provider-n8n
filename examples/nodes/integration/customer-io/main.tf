...
# WORKFLOW
resource "n8n_workflow" "test_customer-io" {
  name       = "Test: Customer.io"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_customer-io.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_customer-io.name
