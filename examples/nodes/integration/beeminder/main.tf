...
# WORKFLOW
resource "n8n_workflow" "test_beeminder" {
  name       = "Test: Beeminder"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_beeminder.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_beeminder.name
