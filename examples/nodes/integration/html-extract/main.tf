# Test workflow for HTML Extract
...
# WORKFLOW
resource "n8n_workflow" "test_html-extract" {
  name   = "Test: HTML Extract"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_html-extract.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_html-extract.name
