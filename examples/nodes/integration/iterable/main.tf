...
# WORKFLOW
resource "n8n_workflow" "test_iterable" {
  name   = "Test: Iterable"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_iterable.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_iterable.name
