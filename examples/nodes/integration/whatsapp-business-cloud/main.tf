# Test workflow for WhatsApp Business Cloud
...
# TESTED NODE: WhatsApp Business Cloud
...
# WORKFLOW
resource "n8n_workflow" "test_whatsapp-business-cloud" {
  name       = "Test: WhatsApp Business Cloud"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_whatsapp-business-cloud.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_whatsapp-business-cloud.name
