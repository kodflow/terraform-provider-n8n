...
# WORKFLOW
resource "n8n_workflow" "test_item-lists" {
  name       = "Test: Item Lists"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_item-lists.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_item-lists.name
