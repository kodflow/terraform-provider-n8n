# Test workflow for One Simple API
...
# WORKFLOW
resource "n8n_workflow" "test_one-simple-api" {
  name   = "Test: One Simple API"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_one-simple-api.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_one-simple-api.name
