...
# WORKFLOW
resource "n8n_workflow" "test_icalendar" {
  name       = "Test: iCalendar"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_icalendar.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_icalendar.name
