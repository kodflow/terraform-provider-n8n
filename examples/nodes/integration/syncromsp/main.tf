...
# WORKFLOW
resource "n8n_workflow" "test_syncromsp" {
  name   = "Test: SyncroMSP"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_syncromsp.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_syncromsp.name
