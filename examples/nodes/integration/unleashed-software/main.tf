# Test workflow for Unleashed Software
...
# TESTED NODE: Unleashed Software
...
# WORKFLOW
resource "n8n_workflow" "test_unleashed-software" {
  name   = "Test: Unleashed Software"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_unleashed-software.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_unleashed-software.name
