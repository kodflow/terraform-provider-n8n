...
# WORKFLOW
resource "n8n_workflow" "test_airtable" {
  name   = "Test: Airtable"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_airtable.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_airtable.name
