# Test workflow for Extraction Values
...
# WORKFLOW
resource "n8n_workflow" "test_extraction-values" {
  name       = "Test: Extraction Values"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_extraction-values.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_extraction-values.name
