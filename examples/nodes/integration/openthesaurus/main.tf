# Test workflow for OpenThesaurus
...
# WORKFLOW
resource "n8n_workflow" "test_openthesaurus" {
  name   = "Test: OpenThesaurus"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_openthesaurus.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_openthesaurus.name
