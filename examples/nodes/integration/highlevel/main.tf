...
# WORKFLOW
resource "n8n_workflow" "test_highlevel" {
  name       = "Test: HighLevel"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_highlevel.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_highlevel.name
