# Test workflow for Write Binary File
...
# WORKFLOW
resource "n8n_workflow" "test_write-binary-file" {
  name       = "Test: Write Binary File"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_write-binary-file.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_write-binary-file.name
