...
# WORKFLOW
resource "n8n_workflow" "test_mailerlite" {
  name       = "Test: MailerLite"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_mailerlite.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_mailerlite.name
