...
# WORKFLOW
resource "n8n_workflow" "test_servicenow" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_servicenow.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_servicenow.name
