...
# WORKFLOW
resource "n8n_workflow" "test_simulate" {
  name   = "Test: Simulate"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_simulate.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_simulate.name
