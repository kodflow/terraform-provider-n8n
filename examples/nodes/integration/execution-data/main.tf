# Test workflow for Execution Data
...
# WORKFLOW
resource "n8n_workflow" "test_execution-data" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_execution-data.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_execution-data.name
