...
# WORKFLOW
resource "n8n_workflow" "test_linkedin" {
  name       = "Test: LinkedIn"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_linkedin.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_linkedin.name
