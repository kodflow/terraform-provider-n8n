...
# WORKFLOW
resource "n8n_workflow" "test_urlscan-io" {
  name   = "Test: urlscan.io"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_urlscan-io.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_urlscan-io.name
