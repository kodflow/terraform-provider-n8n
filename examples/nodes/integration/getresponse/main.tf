...
# WORKFLOW
resource "n8n_workflow" "test_getresponse" {
  name   = "Test: GetResponse"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_getresponse.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_getresponse.name
