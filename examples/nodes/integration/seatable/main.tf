...
# WORKFLOW
resource "n8n_workflow" "test_seatable" {
  name       = "Test: SeaTable"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_seatable.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_seatable.name
