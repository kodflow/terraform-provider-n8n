# Test workflow for QuickBooks Online
...
# WORKFLOW
resource "n8n_workflow" "test_quickbooks-online" {
  name       = "Test: QuickBooks Online"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_quickbooks-online.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_quickbooks-online.name
