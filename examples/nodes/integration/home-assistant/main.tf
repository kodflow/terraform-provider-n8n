# Test workflow for Home Assistant
...
# WORKFLOW
resource "n8n_workflow" "test_home-assistant" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_home-assistant.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_home-assistant.name
