...
# WORKFLOW
resource "n8n_workflow" "test_monica-crm" {
  name   = "Test: Monica CRM"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_monica-crm.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_monica-crm.name
