...
# WORKFLOW
resource "n8n_workflow" "test_travisci" {
  name   = "Test: TravisCI"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_travisci.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_travisci.name
