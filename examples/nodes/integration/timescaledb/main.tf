...
# WORKFLOW
resource "n8n_workflow" "test_timescaledb" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_timescaledb.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_timescaledb.name
