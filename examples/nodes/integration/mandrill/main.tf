...
# WORKFLOW
resource "n8n_workflow" "test_mandrill" {
  name       = "Test: Mandrill"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_mandrill.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_mandrill.name
