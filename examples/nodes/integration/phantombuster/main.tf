# Test workflow for Phantombuster
...
# WORKFLOW
resource "n8n_workflow" "test_phantombuster" {
  name       = "Test: Phantombuster"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_phantombuster.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_phantombuster.name
