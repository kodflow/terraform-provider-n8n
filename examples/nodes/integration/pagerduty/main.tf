...
# WORKFLOW
resource "n8n_workflow" "test_pagerduty" {
  name       = "Test: PagerDuty"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_pagerduty.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_pagerduty.name
