...
# WORKFLOW
resource "n8n_workflow" "test_zoho-crm" {
  name       = "Test: Zoho CRM"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_zoho-crm.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_zoho-crm.name
