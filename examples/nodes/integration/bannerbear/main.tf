...
# WORKFLOW
resource "n8n_workflow" "test_bannerbear" {
  name       = "Test: Bannerbear"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_bannerbear.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_bannerbear.name
