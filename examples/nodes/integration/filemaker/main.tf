...
# WORKFLOW
resource "n8n_workflow" "test_filemaker" {
  name       = "Test: FileMaker"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_filemaker.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_filemaker.name
