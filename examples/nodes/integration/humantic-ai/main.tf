...
# WORKFLOW
resource "n8n_workflow" "test_humantic-ai" {
  name       = "Test: Humantic AI"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_humantic-ai.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_humantic-ai.name
