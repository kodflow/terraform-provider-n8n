# Test workflow for Jira Software
...
# WORKFLOW
resource "n8n_workflow" "test_jira-software" {
  name       = "Test: Jira Software"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_jira-software.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_jira-software.name
