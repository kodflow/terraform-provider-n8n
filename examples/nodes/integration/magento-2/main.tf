...
# WORKFLOW
resource "n8n_workflow" "test_magento-2" {
  name   = "Test: Magento 2"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_magento-2.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_magento-2.name
