# Test workflow for Read Binary Files
...
# WORKFLOW
resource "n8n_workflow" "test_read-binary-files" {
  name       = "Test: Read Binary Files"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_read-binary-files.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_read-binary-files.name
