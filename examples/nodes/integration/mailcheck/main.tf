...
# WORKFLOW
resource "n8n_workflow" "test_mailcheck" {
  name       = "Test: Mailcheck"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_mailcheck.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_mailcheck.name
