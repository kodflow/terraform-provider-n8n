# Test workflow for Stop and Error
...
# WORKFLOW
resource "n8n_workflow" "test_stop-and-error" {
  name   = "Test: Stop and Error"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_stop-and-error.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_stop-and-error.name
