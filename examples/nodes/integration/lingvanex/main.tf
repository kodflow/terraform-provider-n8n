...
# WORKFLOW
resource "n8n_workflow" "test_lingvanex" {
  name       = "Test: LingvaNex"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_lingvanex.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_lingvanex.name
