...
# WORKFLOW
resource "n8n_workflow" "test_function" {
  name   = "Test: Function"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_function.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_function.name
