# Test workflow for X (Formerly Twitter)
...
# TESTED NODE: X (Formerly Twitter)
...
# WORKFLOW
resource "n8n_workflow" "test_x-formerly-twitter" {
  name       = "Test: X (Formerly Twitter)"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_x-formerly-twitter.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_x-formerly-twitter.name
