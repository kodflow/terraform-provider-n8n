...
# WORKFLOW
resource "n8n_workflow" "test_cloudflare" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_cloudflare.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_cloudflare.name
