...
# WORKFLOW
resource "n8n_workflow" "test_automizy" {
  name       = "Test: Automizy"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_automizy.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_automizy.name
