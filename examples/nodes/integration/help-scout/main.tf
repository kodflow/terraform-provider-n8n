...
# WORKFLOW
resource "n8n_workflow" "test_help-scout" {
  name   = "Test: Help Scout"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_help-scout.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_help-scout.name
