...
# WORKFLOW
resource "n8n_workflow" "test_rename-keys" {
  name       = "Test: Rename Keys"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_rename-keys.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_rename-keys.name
