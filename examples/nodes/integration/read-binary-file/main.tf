# Test workflow for Read Binary File
...
# WORKFLOW
resource "n8n_workflow" "test_read-binary-file" {
  name   = "Test: Read Binary File"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_read-binary-file.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_read-binary-file.name
