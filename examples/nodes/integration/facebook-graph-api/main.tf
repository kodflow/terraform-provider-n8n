# Test workflow for Facebook Graph API
...
# TESTED NODE: Facebook Graph API
...
# WORKFLOW
resource "n8n_workflow" "test_facebook-graph-api" {
  name       = "Test: Facebook Graph API"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_facebook-graph-api.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_facebook-graph-api.name
