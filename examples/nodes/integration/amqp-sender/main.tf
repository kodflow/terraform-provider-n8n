...
# WORKFLOW
resource "n8n_workflow" "test_amqp-sender" {
  name   = "Test: AMQP Sender"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_amqp-sender.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_amqp-sender.name
