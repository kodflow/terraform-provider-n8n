...
# WORKFLOW
resource "n8n_workflow" "test_mailchimp" {
  name   = "Test: Mailchimp"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_mailchimp.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_mailchimp.name
