...
# WORKFLOW
resource "n8n_workflow" "test_clockify" {
  name   = "Test: Clockify"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_clockify.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_clockify.name
