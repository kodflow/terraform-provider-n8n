# Test workflow for Respond With
...
# WORKFLOW
resource "n8n_workflow" "test_respond-with" {
  name   = "Test: Respond With"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_respond-with.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_respond-with.name
