...
# WORKFLOW
resource "n8n_workflow" "test_kitemaker" {
  name   = "Test: Kitemaker"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_kitemaker.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_kitemaker.name
