...
# WORKFLOW
resource "n8n_workflow" "test_sticky-note" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_sticky-note.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_sticky-note.name
