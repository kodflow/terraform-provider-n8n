# Test workflow for Convert to/from binary data
...
# TESTED NODE: Convert to/from binary data
...
# WORKFLOW
resource "n8n_workflow" "test_convert-to-from-binary-data" {
  name   = "Test: Convert to/from binary data"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_convert-to-from-binary-data.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_convert-to-from-binary-data.name
