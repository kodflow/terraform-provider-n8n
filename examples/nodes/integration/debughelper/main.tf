...
# WORKFLOW
resource "n8n_workflow" "test_debughelper" {
  name   = "Test: DebugHelper"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_debughelper.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_debughelper.name
