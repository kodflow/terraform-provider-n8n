...
# WORKFLOW
resource "n8n_workflow" "test_coingecko" {
  name       = "Test: CoinGecko"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_coingecko.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_coingecko.name
