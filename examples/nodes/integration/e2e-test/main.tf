...
# WORKFLOW
resource "n8n_workflow" "test_e2e-test" {
  name   = "Test: E2E Test"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_e2e-test.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_e2e-test.name
