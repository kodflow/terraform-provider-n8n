...
# WORKFLOW
resource "n8n_workflow" "test_send-email" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_send-email.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_send-email.name
