...
# WORKFLOW
resource "n8n_workflow" "test_bitwarden" {
  name   = "Test: Bitwarden"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_bitwarden.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_bitwarden.name
