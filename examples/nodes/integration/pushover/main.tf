...
# WORKFLOW
resource "n8n_workflow" "test_pushover" {
  name       = "Test: Pushover"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_pushover.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_pushover.name
