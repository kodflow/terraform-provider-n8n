...
# WORKFLOW
resource "n8n_workflow" "test_dropcontact" {
  name       = "Test: Dropcontact"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_dropcontact.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_dropcontact.name
