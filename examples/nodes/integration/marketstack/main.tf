...
# WORKFLOW
resource "n8n_workflow" "test_marketstack" {
  name   = "Test: Marketstack"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_marketstack.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_marketstack.name
