# Test workflow for ActiveCampaign
...
# WORKFLOW
resource "n8n_workflow" "test_activecampaign" {
  name       = "Test: ActiveCampaign"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_activecampaign.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_activecampaign.name
