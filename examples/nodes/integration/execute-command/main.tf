# Test workflow for Execute Command
...
# WORKFLOW
resource "n8n_workflow" "test_execute-command" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_execute-command.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_execute-command.name
