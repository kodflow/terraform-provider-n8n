# Test workflow for Invoice Ninja
...
# WORKFLOW
resource "n8n_workflow" "test_invoice-ninja" {
  name   = "Test: Invoice Ninja"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_invoice-ninja.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_invoice-ninja.name
