# Test workflow for Action Network
...
# WORKFLOW
resource "n8n_workflow" "test_action-network" {
  name       = "Test: Action Network"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_action-network.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_action-network.name
