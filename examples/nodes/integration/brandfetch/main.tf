...
# WORKFLOW
resource "n8n_workflow" "test_brandfetch" {
  name       = "Test: Brandfetch"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_brandfetch.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_brandfetch.name
