...
# WORKFLOW
resource "n8n_workflow" "test_lonescale" {
  name   = "Test: LoneScale"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_lonescale.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_lonescale.name
