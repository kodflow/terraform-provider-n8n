# Test workflow for Schedule Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_schedule-trigger" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_schedule-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_schedule-trigger.name
