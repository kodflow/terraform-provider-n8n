# Test workflow for Customer Datastore (n8n training)
...
# TESTED NODE: Customer Datastore (n8n training)
...
# WORKFLOW
resource "n8n_workflow" "test_customer-datastore-n8n-training" {
  name       = "Test: Customer Datastore (n8n training)"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_customer-datastore-n8n-training.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_customer-datastore-n8n-training.name
