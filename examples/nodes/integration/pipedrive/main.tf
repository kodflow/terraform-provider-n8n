...
# WORKFLOW
resource "n8n_workflow" "test_pipedrive" {
  name   = "Test: Pipedrive"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_pipedrive.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_pipedrive.name
