...
# WORKFLOW
resource "n8n_workflow" "test_circleci" {
  name       = "Test: CircleCI"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_circleci.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_circleci.name
