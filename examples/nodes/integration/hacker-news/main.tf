...
# WORKFLOW
resource "n8n_workflow" "test_hacker-news" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_hacker-news.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_hacker-news.name
