...
# WORKFLOW
resource "n8n_workflow" "test_autopilot" {
  name       = "Test: Autopilot"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_autopilot.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_autopilot.name
