...
# WORKFLOW
resource "n8n_workflow" "test_clearbit" {
  name       = "Test: Clearbit"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_clearbit.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_clearbit.name
