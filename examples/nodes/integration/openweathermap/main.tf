# Test workflow for OpenWeatherMap
...
# WORKFLOW
resource "n8n_workflow" "test_openweathermap" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_openweathermap.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_openweathermap.name
