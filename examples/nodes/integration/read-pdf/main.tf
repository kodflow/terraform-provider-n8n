...
# WORKFLOW
resource "n8n_workflow" "test_read-pdf" {
  name       = "Test: Read PDF"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_read-pdf.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_read-pdf.name
