# Test workflow for Background Color
...
# WORKFLOW
resource "n8n_workflow" "test_background-color" {
  name   = "Test: Background Color"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_background-color.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_background-color.name
