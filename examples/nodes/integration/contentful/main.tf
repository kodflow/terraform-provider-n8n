...
# WORKFLOW
resource "n8n_workflow" "test_contentful" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_contentful.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_contentful.name
