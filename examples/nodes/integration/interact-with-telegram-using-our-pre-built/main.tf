# Test workflow for Interact with Telegram using our pre-built
...
# TESTED NODE: Interact with Telegram using our pre-built
...
# WORKFLOW
resource "n8n_workflow" "test_interact-with-telegram-using-our-pre-built" {
  name   = "Test: Interact with Telegram using our pre-built"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_interact-with-telegram-using-our-pre-built.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_interact-with-telegram-using-our-pre-built.name
