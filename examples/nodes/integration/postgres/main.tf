...
# WORKFLOW
resource "n8n_workflow" "test_postgres" {
  name   = "Test: Postgres"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_postgres.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_postgres.name
