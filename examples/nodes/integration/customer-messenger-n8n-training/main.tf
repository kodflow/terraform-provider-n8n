# Test workflow for Customer Messenger (n8n training)
...
# TESTED NODE: Customer Messenger (n8n training)
...
# WORKFLOW
resource "n8n_workflow" "test_customer-messenger-n8n-training" {
  name   = "Test: Customer Messenger (n8n training)"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_customer-messenger-n8n-training.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_customer-messenger-n8n-training.name
