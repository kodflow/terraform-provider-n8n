...
# WORKFLOW
resource "n8n_workflow" "test_chargebee" {
  name   = "Test: Chargebee"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_chargebee.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_chargebee.name
