...
# WORKFLOW
resource "n8n_workflow" "test_storyblok" {
  name   = "Test: Storyblok"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_storyblok.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_storyblok.name
