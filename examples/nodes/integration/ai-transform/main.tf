# Test workflow for AI Transform
...
# WORKFLOW
resource "n8n_workflow" "test_ai-transform" {
  name   = "Test: AI Transform"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_ai-transform.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_ai-transform.name
