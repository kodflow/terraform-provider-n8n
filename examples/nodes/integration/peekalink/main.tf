...
# WORKFLOW
resource "n8n_workflow" "test_peekalink" {
  name   = "Test: Peekalink"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_peekalink.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_peekalink.name
