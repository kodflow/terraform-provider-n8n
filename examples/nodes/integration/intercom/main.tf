...
# WORKFLOW
resource "n8n_workflow" "test_intercom" {
  name       = "Test: Intercom"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_intercom.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_intercom.name
