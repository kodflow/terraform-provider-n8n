...
# WORKFLOW
resource "n8n_workflow" "test_rss-read" {
  name   = "Test: RSS Read"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_rss-read.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_rss-read.name
