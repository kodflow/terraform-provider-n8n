...
# WORKFLOW
resource "n8n_workflow" "test_markdown" {
  name       = "Test: Markdown"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_markdown.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_markdown.name
