...
# WORKFLOW
resource "n8n_workflow" "test_affinity" {
  name       = "Test: Affinity"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_affinity.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_affinity.name
