...
# WORKFLOW
resource "n8n_workflow" "test_crowd-dev" {
  name       = "Test: crowd.dev"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_crowd-dev.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_crowd-dev.name
