# Test workflow for Spreadsheet File
...
# WORKFLOW
resource "n8n_workflow" "test_spreadsheet-file" {
  name   = "Test: Spreadsheet File"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_spreadsheet-file.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_spreadsheet-file.name
