# Test workflow for SecurityScorecard
...
# WORKFLOW
resource "n8n_workflow" "test_securityscorecard" {
  name       = "Test: SecurityScorecard"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_securityscorecard.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_securityscorecard.name
