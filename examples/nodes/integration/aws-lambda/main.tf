...
# WORKFLOW
resource "n8n_workflow" "test_aws-lambda" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_aws-lambda.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_aws-lambda.name
