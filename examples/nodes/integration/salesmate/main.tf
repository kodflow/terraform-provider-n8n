...
# WORKFLOW
resource "n8n_workflow" "test_salesmate" {
  name       = "Test: Salesmate"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_salesmate.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_salesmate.name
