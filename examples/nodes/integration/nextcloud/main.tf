...
# WORKFLOW
resource "n8n_workflow" "test_nextcloud" {
  name       = "Test: Nextcloud"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_nextcloud.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_nextcloud.name
