# Test workflow for HTTP Request
...
# WORKFLOW
resource "n8n_workflow" "test_http-request" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_http-request.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_http-request.name
