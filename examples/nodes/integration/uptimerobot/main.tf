...
# WORKFLOW
resource "n8n_workflow" "test_uptimerobot" {
  name       = "Test: UptimeRobot"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_uptimerobot.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_uptimerobot.name
