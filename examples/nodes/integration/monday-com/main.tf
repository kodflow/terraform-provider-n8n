...
# WORKFLOW
resource "n8n_workflow" "test_monday-com" {
  name       = "Test: Monday.com"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_monday-com.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_monday-com.name
