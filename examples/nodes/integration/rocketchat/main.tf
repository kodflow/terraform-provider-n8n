...
# WORKFLOW
resource "n8n_workflow" "test_rocketchat" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_rocketchat.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_rocketchat.name
