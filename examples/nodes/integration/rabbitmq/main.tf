...
# WORKFLOW
resource "n8n_workflow" "test_rabbitmq" {
  name       = "Test: RabbitMQ"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_rabbitmq.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_rabbitmq.name
