# Test workflow for Freshservice
...
# WORKFLOW
resource "n8n_workflow" "test_freshservice" {
  name       = "Test: Freshservice"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_freshservice.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_freshservice.name
