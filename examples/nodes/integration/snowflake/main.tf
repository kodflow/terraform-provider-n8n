...
# WORKFLOW
resource "n8n_workflow" "test_snowflake" {
  name   = "Test: Snowflake"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_snowflake.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_snowflake.name
