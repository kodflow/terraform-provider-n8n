...
# WORKFLOW
resource "n8n_workflow" "test_mistral-ai" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_mistral-ai.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_mistral-ai.name
