...
# WORKFLOW
resource "n8n_workflow" "test_compression" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_compression.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_compression.name
