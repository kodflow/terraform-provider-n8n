...
# WORKFLOW
resource "n8n_workflow" "test_metabase" {
  name   = "Test: Metabase"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_metabase.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_metabase.name
