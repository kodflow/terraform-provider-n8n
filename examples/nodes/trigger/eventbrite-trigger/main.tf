# Test workflow for Eventbrite Trigger
# Category: Trigger
...
# TESTED NODE: Eventbrite Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_eventbrite-trigger" {
  name       = "Test: Eventbrite Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_eventbrite-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_eventbrite-trigger.name
