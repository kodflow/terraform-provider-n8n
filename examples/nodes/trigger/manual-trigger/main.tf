# Test workflow for Manual Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_manual-trigger" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_manual-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_manual-trigger.name
