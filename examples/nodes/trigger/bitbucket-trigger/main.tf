# Test workflow for Bitbucket Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_bitbucket-trigger" {
  name   = "Test: Bitbucket Trigger"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_bitbucket-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_bitbucket-trigger.name
