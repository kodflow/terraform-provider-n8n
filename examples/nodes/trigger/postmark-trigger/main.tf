# Test workflow for Postmark Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_postmark-trigger" {
  name       = "Test: Postmark Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_postmark-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_postmark-trigger.name
