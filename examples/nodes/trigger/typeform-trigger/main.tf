# Test workflow for Typeform Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_typeform-trigger" {
  name       = "Test: Typeform Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_typeform-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_typeform-trigger.name
