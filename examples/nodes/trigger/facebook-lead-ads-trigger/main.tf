# Test workflow for Facebook Lead Ads Trigger
# Category: Trigger
...
# TESTED NODE: Facebook Lead Ads Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_facebook-lead-ads-trigger" {
  name       = "Test: Facebook Lead Ads Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_facebook-lead-ads-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_facebook-lead-ads-trigger.name
