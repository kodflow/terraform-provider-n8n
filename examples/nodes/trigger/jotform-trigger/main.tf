# Test workflow for Jotform Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_jotform-trigger" {
  name       = "Test: Jotform Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_jotform-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_jotform-trigger.name
