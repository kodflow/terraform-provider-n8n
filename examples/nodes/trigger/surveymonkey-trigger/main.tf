# Test workflow for SurveyMonkey Trigger
# Category: Trigger
...
# TESTED NODE: SurveyMonkey Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_surveymonkey-trigger" {
  name   = "Test: SurveyMonkey Trigger"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_surveymonkey-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_surveymonkey-trigger.name
