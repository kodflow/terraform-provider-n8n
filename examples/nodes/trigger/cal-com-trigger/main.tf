# Test workflow for Cal.com Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_cal-com-trigger" {
  name       = "Test: Cal.com Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_cal-com-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_cal-com-trigger.name
