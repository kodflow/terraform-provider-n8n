# Test workflow for Acuity Scheduling Trigger
# Category: Trigger
...
# TESTED NODE: Acuity Scheduling Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_acuity-scheduling-trigger" {
  name       = "Test: Acuity Scheduling Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_acuity-scheduling-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_acuity-scheduling-trigger.name
