...
# WORKFLOW
resource "n8n_workflow" "test_sse-trigger" {
  name       = "Test: SSE Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_sse-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_sse-trigger.name
