# Test workflow for Local File Trigger
# Category: Trigger
...
# TESTED NODE: Local File Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_local-file-trigger" {
  name       = "Test: Local File Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_local-file-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_local-file-trigger.name
