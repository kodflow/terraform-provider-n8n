# Test workflow for Gumroad Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_gumroad-trigger" {
  name       = "Test: Gumroad Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_gumroad-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_gumroad-trigger.name
