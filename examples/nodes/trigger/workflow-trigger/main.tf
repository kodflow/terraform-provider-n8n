# Test workflow for Workflow Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_workflow-trigger" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_workflow-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_workflow-trigger.name
