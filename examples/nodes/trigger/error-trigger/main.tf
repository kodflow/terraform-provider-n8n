# Test workflow for Error Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_error-trigger" {
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_error-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_error-trigger.name
