# Test workflow for Formstack Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_formstack-trigger" {
  name       = "Test: Formstack Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_formstack-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_formstack-trigger.name
