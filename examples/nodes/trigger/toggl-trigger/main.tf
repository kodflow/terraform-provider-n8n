# Test workflow for Toggl Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_toggl-trigger" {
  name   = "Test: Toggl Trigger"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_toggl-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_toggl-trigger.name
