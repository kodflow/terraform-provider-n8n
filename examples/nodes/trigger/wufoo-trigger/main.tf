# Test workflow for Wufoo Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_wufoo-trigger" {
  name   = "Test: Wufoo Trigger"
  active = false
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_wufoo-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_wufoo-trigger.name
