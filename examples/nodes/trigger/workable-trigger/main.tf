# Test workflow for Workable Trigger
# Category: Trigger
...
# WORKFLOW
resource "n8n_workflow" "test_workable-trigger" {
  name       = "Test: Workable Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_workable-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_workable-trigger.name
