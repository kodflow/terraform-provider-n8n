# Test workflow for Email Trigger (IMAP)
# Category: Trigger
...
# TESTED NODE: Email Trigger (IMAP)
...
# WORKFLOW
resource "n8n_workflow" "test_email-trigger-imap" {
  name       = "Test: Email Trigger (IMAP)"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_email-trigger-imap.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_email-trigger-imap.name
