...
# WORKFLOW
resource "n8n_workflow" "test_n8n-trigger" {
  name       = "Test: n8n Trigger"
...
# OUTPUTS
output "workflow_id" {
  value       = n8n_workflow.test_n8n-trigger.id
  description = "ID of the test workflow"
}

output "workflow_name" {
  value       = n8n_workflow.test_n8n-trigger.name
